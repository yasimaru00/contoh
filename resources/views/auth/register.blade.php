                  ...
                  <div class="card rounded-0 mb-0 p-2">
                      ...
                      <div class="card-content">
                          <div class="card-body pt-0">
                            <form id="form-register" method="POST" data-href="{{ route('api-register') }}">
                              @csrf
                                  ...
                                  <button type="button" id="btn-register" class="btn btn-primary float-right btn-inline mb-50" onClick="register()" redirect-href="{{ $redirectUrl }}">Register</a>
                              </form>
                          </div>
                      </div>
                  </div>

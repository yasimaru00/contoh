 ...
 * START FROM HERE
 */
Route::get('/test/send-email', 'TestDeveloper\TestController@SendEmail');
Route::get('/auth/login', 'Auth\LoginController@showLoginForm');
Route::post('/auth/login', 'Auth\LoginController@login');
Route::get('/auth/login/pinpoint', 'Auth\LoginController@pinpoint');
Route::get('/auth/register', 'Auth\RegisterController@showRegistrationForm')->name('auth/register');
Route::any('/auth/register/sendEmail', 'Auth\RegisterController@sendEmail')->name('sendEmail');
Route::any('/auth/register/verify', 'Auth\RegisterController@verify')->name('verify');
...
Route::group(['middleware' => 'web'], function () {
    ...
    Route::get('/portal-guest', 'PortalController@indexGuest');
    Route::get('/application-form','ApplicationFormController@index');
    Route::get('/vacancy', 'VacancyController@index');
    Route::get('/vacancy/view/{uuid}', 'VacancyController@view');
    Route::get('/vacancy/example', 'VacancyController@example');
    Route::get('/application-form','ApplicationFormController@index');
    // Route::get('/application-form/view/{uuid}','ApplicationFormController@view');
});
